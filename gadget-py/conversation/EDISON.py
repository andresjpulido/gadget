...
def record_audio(ask=False):
    speak('hi, i am S.T., nice to meet you!')
...
def respond(voice_data):
    ...
    if there_exists(["what is your name","what's your name","tell me your name"]):
        if person_obj.name:
            speak2("my name is Edison nice to meet you! ")
        else:
            speak2("my name is Edison what's your name?")

    if there_exists(["my name is"]):
        person_name = voice_data.split("is")[-1].strip()
        speak2(f"okay, i will remember that {person_name}")
